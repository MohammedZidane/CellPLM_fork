...
class ZINB(nn.Module):
    ...
    def __init__(self, hidden_dim, out_dim, n_dec_1=128, softmax=True, disp='protein'):
        super().__init__()
...
class NB(nn.Module):
    ...
    def __init__(self, hidden_dim, out_dim, n_dec_1=128, softmax=False, disp='protein'):
        super().__init__()
        self.dec_1 = nn.Linear(hidden_dim, n_dec_1)
        self.dec_mean = nn.Sequential(nn.Linear(n_dec_1, out_dim), MeanAct(softmax))
        self.disp = disp
